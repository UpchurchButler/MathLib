 ...
 *Co-effs 1 is assumed to be the HIGH order of the equation.
 *Thus for ax^2+bx+c - the set would need to be Coef := [a,b,c];.
 *@param x, the value of x in the polynomial.
 *@param Coeffs, a set of coefficients forthe polynomial.
 *The ALL set is considered to be all zero values.
